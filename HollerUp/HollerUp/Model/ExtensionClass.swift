...
extension UIColor{
    static var themeColor:UIColor{
        return #colorLiteral(red: 0.04705882353, green: 0.7137254902, blue: 0.8470588235, alpha: 1) //0cb6d8
    }
    static var themeColor1:UIColor{
    ...
    static var highlightColor:UIColor{
        return #colorLiteral(red: 0, green: 0.7215686275, blue: 0.5803921569, alpha: 1) //00b894
    }
    static var highlightColor1:UIColor{
        return #colorLiteral(red: 0.9411764706, green: 0.3725490196, blue: 0.231372549, alpha: 1) //f05f3b
    }
